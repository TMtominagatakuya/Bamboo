...
public class UserController {
	...
	// ユーザ新規登録画面
		...
		public ModelAndView saveUsers(@AuthenticationPrincipal UserDetail userDetail, @ModelAttribute("user") @Validated User user, BindingResult result, ModelAndView mav) {
			if(!result.hasErrors()) {
